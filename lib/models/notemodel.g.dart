...
NoteModel _noteModelDeserialize(
  ...
  final object = NoteModel(
    ...
    isStarred: reader.readBoolOrNull(offsets[3]) ?? false,
...
extension NoteModelQueryFilter
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorcodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorcodeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorcodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> isStarredEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension NoteModelQuerySortBy on QueryBuilder<NoteModel, NoteModel, QSortBy> {
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByColorcode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorcode', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByColorcodeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByIsStarred() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isStarred', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByIsStarredDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQuerySortThenBy
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByColorcode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorcode', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByColorcodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorcode', Sort.desc);
    });
  }
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByIsStarred() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isStarred', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByIsStarredDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isStarred', Sort.desc);
    });
  }
...
extension NoteModelQueryWhereDistinct
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByColorcode() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByIsStarred() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryProperty
  ...
  QueryBuilder<NoteModel, int, QQueryOperations> colorcodeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, bool, QQueryOperations> isStarredProperty() {
    return QueryBuilder.apply(this, (query) {
